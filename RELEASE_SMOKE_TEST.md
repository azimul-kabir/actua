...
- [ ] From a deep detail screen, repeatedly press/gesture Back and verify the app collapses to the Home tab (not Budget) before the next back press exits the app.
